...
M_.param_names(7) = {'z_s'};
M_.param_names_tex(7) = {'z\_s'};
M_.param_names_long(7) = {'z_s'};
M_.param_names(8) = {'k_s'};
M_.param_names_tex(8) = {'k\_s'};
M_.param_names_long(8) = {'k_s'};
M_.param_names(9) = {'c_s'};
M_.param_names_tex(9) = {'c\_s'};
M_.param_names_long(9) = {'c_s'};
M_.param_names(10) = {'l_s'};
M_.param_names_tex(10) = {'l\_s'};
M_.param_names_long(10) = {'l_s'};
...
l_s = M_.params(10);
M_.params(8) = ((1/M_.params(2)-1+M_.params(4))/(M_.params(3)*M_.params(10)^M_.params(3)))^(1/(M_.params(3)-1));
k_s = M_.params(8);
M_.params(9) = M_.params(8)^M_.params(3)*M_.params(10)^(1-M_.params(3))-M_.params(4)*M_.params(8);
c_s = M_.params(9);
M_.params(6) = M_.params(10)^M_.params(3)*M_.params(9)/(M_.params(10)^M_.params(3)*M_.params(9)+M_.params(8)^M_.params(3)-M_.params(3)*M_.params(8)^M_.params(3)-M_.params(10)*M_.params(8)^M_.params(3)+M_.params(10)*M_.params(3)*M_.params(8)^M_.params(3));
gamma = M_.params(6);
%
...
save([M_.dname filesep 'Output' filesep 'model2e_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model2e_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model2e_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model2e_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model2e_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model2e_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model2e_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
