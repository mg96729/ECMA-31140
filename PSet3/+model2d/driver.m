...
M_.param_names(7) = {'l_s'};
M_.param_names_tex(7) = {'l\_s'};
M_.param_names_long(7) = {'l_s'};
M_.param_names(8) = {'k_0'};
M_.param_names_tex(8) = {'k\_0'};
M_.param_names_long(8) = {'k_0'};
...
l_s = M_.params(7);
M_.params(5) = M_.params(7)*(1/M_.params(1)*(1/M_.params(2)-1+M_.params(3)))^(1/(M_.params(1)-1));
k_s = M_.params(5);
...
save([M_.dname filesep 'Output' filesep 'model2d_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model2d_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model2d_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model2d_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model2d_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model2d_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model2d_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
